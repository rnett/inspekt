...
| | |
|---|---|
| [dev.rnett.inspekt.exceptions.InspektNotIntrinsifiedException](../dev.rnett.inspekt.exceptions/-inspekt-not-intrinsified-exception/index.md) | if it was not intrinsified by the Inspekt compiler plugin. |
