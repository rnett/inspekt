...
| Name | Summary |
|---|---|
| [InternalInspektApi](-internal-inspekt-api/index.md) | [common]<br>annotation class [InternalInspektApi](-internal-inspekt-api/index.md)<br>Marks internal Inspekt APIs that should not be used outside of the library. |
