...
| Name | Summary |
|---|---|
| [InternalInspektApi](-internal-inspekt-api/index.md) | [common]<br>@[RequiresOptIn](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-requires-opt-in/index.html)(message = &quot;This is an internal Inspekt API and should not be used outside of the project.&quot;, level = [RequiresOptIn.Level.ERROR](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-requires-opt-in/-level/-e-r-r-o-r/index.html))<br>annotation class [InternalInspektApi](-internal-inspekt-api/index.md)<br>Marks internal Inspekt APIs that should not be used outside of the library. |
