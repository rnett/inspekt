//[inspekt](../../../index.md)/[dev.rnett.inspekt.model](../index.md)/[Property](index.md)

# Property

sealed class [Property](index.md) : [Callable](../-callable/index.md)
...
| |
|---|
| [ReadOnlyProperty](../-read-only-property/index.md) |
| [MutableProperty](../-mutable-property/index.md) |
...
| [getter](getter.md) | [common]<br>val [getter](getter.md): [PropertyGetter](../-property-getter/index.md)<br>The property's getter. |
| [hasBackingField](has-backing-field.md) | [common]<br>val [hasBackingField](has-backing-field.md): [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html)<br>Whether the property has a backing field. |
| [hasDelegate](has-delegate.md) | [common]<br>val [hasDelegate](has-delegate.md): [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html)<br>Whether the property has a delegate. |
...
| [kotlin](kotlin.md) | [common]<br>abstract override val [kotlin](kotlin.md): [KProperty1](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.reflect/-k-property1/index.html)&lt;*, *&gt;<br>A reference to the Kotlin declaration this represents. |
| [name](name.md) | [common]<br>open override val [name](name.md): [CallableName](../../dev.rnett.inspekt.model.name/-callable-name/index.md)<br>The fully qualified name of the declaration. |
...
| [setter](setter.md) | [common]<br>open val [setter](setter.md): [PropertySetter](../-property-setter/index.md)?<br>The property's setter, if it has one. |
...
| [type](type.md) | [common]<br>val [type](type.md): [KType](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.reflect/-k-type/index.html)<br>The type of the property. |
...
| [get](get.md) | [common]<br>fun [get](get.md)(arguments: [ArgumentList](../../dev.rnett.inspekt.model.arguments/-argument-list/index.md)): [Any](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-any/index.html)?<br>Gets the value of a property by calling its getter.<br>[common]<br>fun [get](get.md)(arguments: [ArgumentsBuilder](../../dev.rnett.inspekt.model.arguments/-arguments-builder/index.md)): [Any](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-any/index.html)?<br>Get the value of a property by calling its getter. |
