//[inspekt](../../../index.md)/[dev.rnett.inspekt.model](../index.md)/[SimpleFunction](index.md)

# SimpleFunction

[common]\
class [SimpleFunction](index.md) : [Function](../-function/index.md)
...
| [kotlin](kotlin.md) | [common]<br>open override val [kotlin](kotlin.md): [KFunction](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.reflect/-k-function/index.html)&lt;*&gt;<br>A reference to the Kotlin declaration this represents. |
...
| [typeParameters](type-parameters.md) | [common]<br>val [typeParameters](type-parameters.md): [List](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html)&lt;[TypeParameter](../-type-parameter/index.md)&gt; |
