//[inspekt](../../../index.md)/[dev.rnett.inspekt.model](../index.md)/[PropertySetter](index.md)

# PropertySetter

[common]\
class [PropertySetter](index.md) : [PropertyAccessor](../-property-accessor/index.md)
...
| [property](property.md) | [common]<br>open override val [property](property.md): [Property](../-property/index.md)<br>The property this accessor belongs to. |
