//[inspekt](../../../index.md)/[dev.rnett.inspekt.model](../index.md)/[ReadOnlyProperty](index.md)

# ReadOnlyProperty

[common]\
class [ReadOnlyProperty](index.md) : [Property](../-property/index.md)
...
| [kotlin](kotlin.md) | [common]<br>open override val [kotlin](kotlin.md): [KProperty1](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.reflect/-k-property1/index.html)&lt;*, *&gt;<br>A reference to the Kotlin declaration this represents. |
...
| [setter](../-property/setter.md) | [common]<br>open val [setter](../-property/setter.md): [PropertySetter](../-property-setter/index.md)?<br>The property's setter, if it has one. |
