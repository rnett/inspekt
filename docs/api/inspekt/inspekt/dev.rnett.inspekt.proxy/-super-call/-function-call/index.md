//[inspekt](../../../../index.md)/[dev.rnett.inspekt.proxy](../../index.md)/[SuperCall](../index.md)/[FunctionCall](index.md)

# FunctionCall

[common]\
data class [FunctionCall](index.md)(val superFunction: [SimpleFunction](../../../dev.rnett.inspekt.model/-simple-function/index.md), val args: [ArgumentList](../../../dev.rnett.inspekt.model.arguments/-argument-list/index.md)) : [SuperCall](../index.md)
...
| | |
|---|---|
| [FunctionCall](-function-call.md) | [common]<br>constructor(superFunction: [SimpleFunction](../../../dev.rnett.inspekt.model/-simple-function/index.md), args: [ArgumentList](../../../dev.rnett.inspekt.model.arguments/-argument-list/index.md)) |
...
| [superFun](super-fun.md) | [common]<br>open override val [superFun](super-fun.md): [SimpleFunction](../../../dev.rnett.inspekt.model/-simple-function/index.md)<br>The function originally being called. |
| [superFunction](super-function.md) | [common]<br>val [superFunction](super-function.md): [SimpleFunction](../../../dev.rnett.inspekt.model/-simple-function/index.md) |
