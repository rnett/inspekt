//[inspekt](../../../../index.md)/[dev.rnett.inspekt.proxy](../../index.md)/[SuperCall](../index.md)/[PropertyAccess](index.md)

# PropertyAccess

sealed class [PropertyAccess](index.md) : [SuperCall](../index.md)

#### Inheritors

| |
|---|
| [PropertyGet](../-property-get/index.md) |
| [PropertySet](../-property-set/index.md) |
...
| [superFun](super-fun.md) | [common]<br>abstract override val [superFun](super-fun.md): [PropertyAccessor](../../../dev.rnett.inspekt.model/-property-accessor/index.md)<br>The function originally being called. |
| [superProperty](super-property.md) | [common]<br>abstract override val [superProperty](super-property.md): [Property](../../../dev.rnett.inspekt.model/-property/index.md) |
