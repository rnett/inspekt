...
package dev.rnett.inspekt.auto.annotation.compile;
...
@TestMetadata("src/testData/auto/annotation/compile")
@TestDataPath("$PROJECT_ROOT")
@TestWithLevel(level = TestLevel.Diagnostics)
@TestWithLevel(level = TestLevel.FIR)
@TestWithLevel(level = TestLevel.IR)
public class AnnotationCompileTestGenerated extends AbstractLeveledIrTest {
  @Override
  ...
  public void testAllFilesPresentInCompile() {
    KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("src/testData/auto/annotation/compile"), Pattern.compile("^(.+)\\.kt$"), null, true);
  }

  @Test
  @TestMetadata("Basic.kt")
  public void testBasic() {
    runTest("src/testData/auto/annotation/compile/Basic.kt");
  }
}
