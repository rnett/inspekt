...
class SpektSpec(val defaultWarnOn: Int) {
...
class Registrar : BaseSpecCompilerPluginRegistrar<SpektSpec>() {
    ...
    override fun produceSpec(configuration: CompilerConfiguration): SpektSpec = SpektSpec(configuration[CliOptions.warnOnDefaultArguments])
